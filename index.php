...
<html lang="es">
<head>
	<title>LoginCECIN</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<link rel="stylesheet" href="./css/main.css">
</head>
<body class="cover" style="background-image: url(./assets/img/loginFont.jpg);">
	<form action="home.php" method="" autocomplete="on" class="full-box logInForm">		
		<p class="text-center text-muted"><i class="zmdi zmdi-account-circle zmdi-hc-5x"></i></p>
		<p class="text-center text-muted text-uppercase">Ingresa con tu cuenta</p>
		...
		<div class="form-group text-center">
			<input type="submit" value="Entrar" class="btn btn-raised btn-danger">
		</div>
	</form>
	<!--====== Scripts -->
